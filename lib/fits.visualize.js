...
(function() {
  ...
  Visualize = (function() {
    ...
    function Visualize(imgset, el) {
      ...
      this.gl.texImage2D(this.gl.TEXTURE_2D, 0, this.gl.LUMINANCE, this.width, this.height, 0, this.gl.LUMINANCE, this.gl.FLOAT, this.imgset[3].getHDU().data.getFrameWebGL());
