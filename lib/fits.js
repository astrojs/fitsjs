...
(function() {
  ...
  Image = (function(_super) {
    ...
    function Image(header, view, offset) {
      this.incrementOffset = __bind(this.incrementOffset, this);
      ...
      this.rowByteSize = this.width * this.bytes;
    ...
    Image.prototype.incrementOffset = function() {
      return this.offset += this.bytes;
    };
