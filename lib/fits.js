...
(function() {
  ...
  BinaryTable = (function(_super) {
    ...
    BinaryTable.prototype.setAccessors = function(header) {
      var count, descriptor, i, key, value, _i, _ref, _results,
        _this = this;
      _results = [];
      for (i = _i = 1, _ref = this.cols; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
        key = "TFORM" + i;
        ...
        count = value[0] === descriptor ? 1 : parseInt(value.slice(0, -1));
        if (descriptor === 'P' || descriptor === 'Q') {
          _results.push((function(descriptor, count) {
            var accessor;
            accessor = function() {
              var chunk, heapOffset, length, offset;
              length = _this.view.getInt32(_this.offset);
              _this.offset += 4;
              offset = _this.view.getInt32(_this.offset);
              _this.offset += 4;
              heapOffset = _this.begin + _this.tableLength + offset;
              chunk = _this.view.buffer.slice(heapOffset, heapOffset + length);
              return new _this.typedArray(chunk);
            };
            return _this.accessors.push(accessor);
          })(descriptor, count));
        } else {
  ...
  CompressedImage = (function(_super) {
            ...
            case "COMPRESSED_DATA":
              (function(dataType) {
                return accessor = function() {
                  ...
                  _this.constructor.Rice(data, _this.params["BLOCKSIZE"], _this.params["BYTEPIX"], pixels, _this.ztile[0]);
                  return pixels;
                };
              })(dataType);
              break;
          ...
          if (length === 0 || length === 1) {
            ...
            (function(length, dataType) {
              return accessor = function() {
                ...
                data = new _this.typedArray[dataType](length);
    ...
    CompressedImage.prototype.setRiceDefaults = function() {
      if (!this.params.hasOwnProperty("BLOCKSIZE")) {
        this.params["BLOCKSIZE"] = 32;
      }
      if (!this.params.hasOwnProperty("BYTEPIX")) {
    ...
    CompressedImage.prototype._accessor = function(dataType) {
      ...
      data = new this.typedArray[dataType](length);
