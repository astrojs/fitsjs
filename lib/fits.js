...
(function() {
  ...
  CompressedImage = (function(_super) {
    ...
    CompressedImage.prototype._getRows = function(buffer) {
      var accessor, arr, blank, data, i, index, nRows, nTile, offset, r, rIndex, row, scale, seed0, seed1, value, view, zero, _i, _j, _len, _len1, _ref, _ref1;
      nRows = buffer.byteLength / this.rowByteSize;
      view = new DataView(buffer);
      offset = 0;
