...
(function(/*! Stitch !*/) {
...
}).call(this)({"fits.binarytable": function(exports, require, module) {(function() {
...
}, "fits.compressedimage": function(exports, require, module) {(function() {
  ...
  CompImage = (function(_super) {
    ...
    function CompImage(view, header) {
      ...
      this.ztile = [];
      for (i = 1, _ref = this.znaxis; 1 <= _ref ? i <= _ref : i >= _ref; 1 <= _ref ? i++ : i--) {
    ...
    CompImage.prototype.defineColumnAccessors = function(header) {
      var accessor, dataType, i, length, match, ttype, value, _ref, _ref2, _results,
        _this = this;
      this.columnNames = {};
      _results = [];
      for (i = 1, _ref = this.cols; 1 <= _ref ? i <= _ref : i >= _ref; 1 <= _ref ? i++ : i--) {
          ...
          if (length === 0 || length === 1) {
            ...
            (function(length, dataType) {
              return accessor = function() {
                ...
                for (i = 0, _ref3 = length - 1; 0 <= _ref3 ? i <= _ref3 : i >= _ref3; 0 <= _ref3 ? i++ : i--) {
    ...
    CompImage.prototype.getRowHasBlanks = function() {
      var blank, data, index, location, scale, value, zero, _len, _ref;
    ...
    CompImage.prototype.getFrame = function() {
      var height;
      if (this.data == null) this.initArray(Float32Array);
    ...
    CompImage.prototype._accessor = function(dataType) {
      var data, i, length, offset, _ref, _ref2;
      ...
      for (i = 0, _ref2 = length - 1; 0 <= _ref2 ? i <= _ref2 : i >= _ref2; 0 <= _ref2 ? i++ : i--) {
  ...
  if (typeof module !== "undefined" && module !== null) module.exports = CompImage;

}).call(this);
}, "fits.data": function(exports, require, module) {(function() {
  var Data, Module,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  if (typeof module !== "undefined" && module !== null) module.exports = Data;

}).call(this);
}, "fits.decompress": function(exports, require, module) {(function() {
  var Decompress;

  Decompress = {
    Rice: function(array, arrayLen, blocksize, bytepix, pixels, nx) {
      var b, bbits, diff, fs, fsbits, fsmax, i, imax, k, lastpix, nbits, nonzeroCount, nzero, pointer, _ref, _ref2;
      bbits = 1 << fsbits;
      ...
      nzero = 8;
      _ref2 = [128, 255], k = _ref2[0], i = _ref2[1];
      while (i >= 0) {
        while (i >= k) {
...
}, "fits.file": function(exports, require, module) {(function() {
  ...
  File = (function() {
    ...
    File.prototype.checkEOF = function() {
      if (this.view.offset >= this.length) return this.eof = true;
    };
    ...
    File.prototype.getHDU = function(index) {
      ...
      if ((index != null) && (this.hdus[index] != null)) return this.hdus[index];
      _ref = this.hdus;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        hdu = _ref[_i];
  ...
  if (typeof module !== "undefined" && module !== null) module.exports = File;

}).call(this);
}, "fits.hdu": function(exports, require, module) {(function() {
  var HDU;
  ...
  if (typeof module !== "undefined" && module !== null) module.exports = HDU;

}).call(this);
}, "fits.header": function(exports, require, module) {(function() {
  ...
  Header = (function(_super) {
    ...
    Header.prototype.readCard = function(line) {
      var array, comment, index, key, keyToVerify, match, value, _ref, _ref2, _ref3, _ref4, _ref5;
      ...
      if (key === "COMMENT" || key === "HISTORY") {
        ...
        match[1] = (_ref2 = match[1][0]) === "T" || _ref2 === "F" ? match[1].trim() : parseFloat(match[1]);
      }
      match[2] = match[2].trim();
      _ref3 = match.slice(1), value = _ref3[0], comment = _ref3[1];
      keyToVerify = key;
      _ref4 = [false, void 0], array = _ref4[0], index = _ref4[1];
      match = key.match(Header.arrayPattern);
      if (match != null) {
        keyToVerify = match[1];
        _ref5 = [true, match[2]], array = _ref5[0], index = _ref5[1];
      }
    ...
    Header.prototype.init = function(block) {
      var i, line, lineWidth, maxNumLines, numLines, _ref, _results;
      lineWidth = 80;
      numLines = block.length / lineWidth;
      maxNumLines = 180;
      numLines = numLines < maxNumLines ? numLines : maxNumLines;
      _results = [];
      for (i = 0, _ref = numLines - 1; 0 <= _ref ? i <= _ref : i >= _ref; 0 <= _ref ? i++ : i--) {
  ...
  if (typeof module !== "undefined" && module !== null) module.exports = Header;

}).call(this);
}, "fits.header.verify": function(exports, require, module) {(function() {
  var VerifyCards,
  ...
  VerifyCards = {
    ...
    Functions: {
      ...
      ZNAXIS: function() {
        ...
        array = arguments[1];
        value = value;
        if (!array) this.verifyBetween(key, value, 0, 999);
        return value;
      },
      ZTILE: function() {
        var args, key;
...
}, "fits.image": function(exports, require, module) {(function() {
  ...
  Image = (function(_super) {
    ...
    function Image(view, header) {
      ...
      this.naxis = [];
      for (i = 1; 1 <= naxis ? i <= naxis : i >= naxis; 1 <= naxis ? i++ : i--) {
    ...
    Image.prototype.getFrame = function(frame) {
      ...
      if (this.data == null) this.initArray(this.arrayType);
  ...
  if (typeof module !== "undefined" && module !== null) module.exports = Image;

}).call(this);
}, "fits.image.utils": function(exports, require, module) {(function() {
  var ImageUtils;
...
}, "fits": function(exports, require, module) {(function() {
  var FITS;
...
}, "fits.module": function(exports, require, module) {(function() {
  ...
  if (typeof module !== "undefined" && module !== null) module.exports = Module;

}).call(this);
}, "fits.table": function(exports, require, module) {(function() {
  var Table, Tabular,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
...
}, "fits.tabular": function(exports, require, module) {(function() {
  var Data, Tabular,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  if (typeof module !== "undefined" && module !== null) module.exports = Tabular;
