            ...
            case "COMPRESSED_DATA":
              (function(dataType) {
                return accessor = function() {
                  ...
                  _this.constructor.Rice(data, data.length, _this.algorithmParameters["BLOCKSIZE"], _this.algorithmParameters["BYTEPIX"], pixels, _this.ztile[0]);
                  return pixels;
                };
              })(dataType);
              break;
  ...
  File = (function() {
    ...
    File.prototype.readHeader = function() {
      ...
      while (true) {
        ...
        block = this.view.getString(this.offset, File.BLOCKLENGTH);
        this.offset += File.BLOCKLENGTH;
        i = 0;
        while (true) {
