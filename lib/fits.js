...
(function() {
  ...
  Image = (function(_super) {
    ...
    Image.prototype.getFrameAsync = function(frame, callback, params) {
      ...
      fn1 = "onmessage = " + fn1;
      fn2 = this.constructor._getFrame.toString();
    ...
    Image.prototype.getFrame = function(frame) {
      var arr;
      this.frame = frame != null ? frame : this.frame;
      arr = this.constructor._getFrame(this.view.buffer, this.width, this.height, this.offset, this.frame, this.bytes, this.bitpix, this.bzero, this.bscale);
      if (this.isDataCube()) {
        this.frame += 1;
      }
      return arr;
            ...
            case "COMPRESSED_DATA":
              _results.push((function(descriptor, count) {
                ...
                accessor = function() {
                  ...
                  astro.FITS.Decompress.Rice(arr, _this.params["BLOCKSIZE"], _this.params["BYTEPIX"], pixels, _this.ztile[0]);
                  return pixels;
                };
                return _this.accessors.push(accessor);
              })(descriptor, count));
  ...
  Decompress = {
    ...
    Rice: function(array, blocksize, bytepix, pixels, nx) {
      ...
      bbits = 1 << fsbits;
      _ref = Decompress.RiceSetup[bytepix](array), fsbits = _ref[0], fsmax = _ref[1], lastpix = _ref[2], pointer = _ref[3];
  ...
  CompressedImage.prototype.getFrameAsync = function(frame, callback) {
    var URL, algoBlob, algoBlobUrl, blob, blobUrl, data, fn, onmessage, worker;
    this.frame = frame != null ? frame : this.frame;
    onmessage = function(e) {
      var Rice, RiceSetup, accessors, arr, bitpix, blank, bscale, buffer, bzero, columnNames, data, dataAccessors, defGetRow, getFrame, getFromHeap, getRow, getRowHasBlanks, getRowNoBlanks, getTableRow, height, offset, params, rowByteSize, rowsRead, setAccessors, swapEndian, tableColumns, tableLength, typedArray, view, width, zblank, ztile;
      data = e.data;
      ...
      Rice = function(array, blocksize, bytepix, pixels, nx) {
        var b, bbits, diff, fs, fsbits, fsmax, i, imax, k, lastpix, nbits, nonzeroCount, nzero, pointer, _ref, _ref1;
        bbits = 1 << fsbits;
        _ref = RiceSetup[bytepix](array), fsbits = _ref[0], fsmax = _ref[1], lastpix = _ref[2], pointer = _ref[3];
        nonzeroCount = new Uint8Array(256);
        nzero = 8;
        _ref1 = [128, 255], k = _ref1[0], i = _ref1[1];
        while (i >= 0) {
    ...
    fn = "onmessage = " + fn;
    URL = URL || webkitURL;
    algoBlob = new Blob([astro.FITS.Decompress], {
