  ...
  CompressedImage = (function(_super) {
    ...
    function CompressedImage(header, view, offset) {
      ...
      if (this.zcmptype === 'RICE_1') {
        if (!("BLOCKSIZE" in this.algorithmParameters)) {
          this.algorithmParameters["BLOCKSIZE"] = 32;
        }
        if (!("BYTEPIX" in this.algorithmParameters)) {
    ...
    CompressedImage.prototype.defGetRow = function() {
      var hasBlanks;
      hasBlanks = (this.zblank != null) || (this.blank != null) || this.cols.indexOf("ZBLANK") > -1;
      return this.getRow = hasBlanks ? this._getRowHasBlanks : this._getRowNoBlanks;
    };
