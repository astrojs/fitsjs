...
(function() {
  ...
  Image = (function(_super) {
    ...
    Image.prototype._getFrameAsync = function(buffer, callback, opts) {
    ...
    Image.prototype.getFrame = function(frame, callback, opts) {
      ...
      if (buffer != null) {
        return this._getFrameAsync(buffer, callback, opts);
      } else {
    ...
    Image.prototype.getFrames = function(frame, number, callback, opts) {
      ...
      cb = function(arr, opts) {
        ...
        if (number) {
          ...
          return _this.invoke(callback, opts, arr);
        }
      };
  ...
  Tabular = (function(_super) {
    ...
    Tabular.prototype.getColumn = function(name, row, number, callback, opts) {
      var accessor, byteOffset, cb, column, columnIndex, descriptor, i, index, length, reader, rowByteSize, slice, _i,
        _this = this;
      ...
      if (this.blob != null) {
        ...
        return this.getRows(row, number, cb, opts);
      }
    };
