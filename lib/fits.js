...
(function() {
  ...
  Image = (function(_super) {
    ...
    Image.prototype._getFrameAsync = function(buffers, callback, opts) {
      var blobGetFrame, blobOnMessage, fn1, fn2, i, mime, msg, onmessage, urlGetFrame, urlOnMessage, worker,
        _this = this;
    ...
    Image.prototype.getFrame = function(frame, callback, opts) {
      var begin, blobFrame, blobs, buffers, chunkLength, frameInfo, i, length, reader, start, _i, _ref,
        _this = this;
      ...
      if ((buffers != null ? buffers.length : void 0) === this.nBuffers) {
        ...
        chunkLength = length / this.nBuffers;
        blobs = [];
