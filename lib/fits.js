...
(function() {
  ...
  CompressedImage = (function(_super) {
    ...
    function CompressedImage(header, view, offset) {
      ...
      this._getRows = hasBlanks ? this._getRowsHasBlanks : this._getRowsNoBlanks;
    }

    CompressedImage.prototype._getRowsHasBlanks = function(buffer) {
    ...
    CompressedImage.prototype._getRowsNoBlanks = function(buffer) {
