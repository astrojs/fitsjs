...
(function() {
  ...
  ImageUtils = {
    ...
    getPixel: function(x, y, z) {
      z = z || 0;
      this.offset = this.begin + ((y + this.height * z) * this.width + x) * this.bytes;
  ...
  Image = (function(_super) {
      ...
      switch (bitpix) {
        case 8:
          if (this.bscale % 1 === 0) {
            ...
            this.accessor = function() {
              return _this.bzero + _this.bscale * _this.view.getUint8(_this.offset);
            };
          } else {
        ...
        case 16:
          if (this.bscale % 1 === 0) {
            ...
            this.accessor = function() {
              return _this.bzero + _this.bscale * _this.view.getInt16(_this.offset);
            };
          } else {
            this.arrayType = Float32Array;
            this.accessor = function() {
        ...
        case 32:
          if (this.bscale % 1 === 0) {
            ...
            this.accessor = function() {
              return _this.bzero + _this.bscale * _this.view.getUint32(_this.offset);
            };
          } else {
            this.arrayType = Float32Array;
            this.accessor = function() {
        ...
        case -32:
          this.arrayType = Float32Array;
          this.accessor = function() {
            return _this.bzero + _this.bscale * _this.view.getFloat32(_this.offset);
          };
          break;
        default:
    ...
    Image.prototype.getFrame = function(frame) {
      var arr, index, length, _i, _ref;
      this.frame = frame != null ? frame : this.frame;
      length = this.width * this.height;
      arr = new this.arrayType(length);
      this.offset = this.begin + this.frame * arr.byteLength;
      for (index = _i = 0, _ref = length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; index = 0 <= _ref ? ++_i : --_i) {
        arr[index] = this.accessor();
  ...
  BinaryTable = (function(_super) {
    ...
    BinaryTable.prototype.dataTypePattern = /(\d*)([L|X|B|I|J|K|A|E|D|C|M])/;

    BinaryTable.prototype.arrayDescriptorPattern = /[0,1]*P([L|X|B|I|J|K|A|E|D|C|M])\((\d*)\)/;
    ...
    function BinaryTable(header, view, offset) {
      ...
      for (i = _i = 1, _ref = this.cols; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
        ...
        match = value.match(this.arrayDescriptorPattern);
        if (match != null) {
          (function() {
            var accessor, dataType;
            dataType = match[1];
            accessor = function() {
              var data, length, tempOffset, val, _j, _ref1;
              length = _this.view.getInt32(_this.offset);
              _this.offset += 4;
              offset = _this.view.getInt32(_this.offset);
              _this.offset += 4;
              tempOffset = _this.offset;
              _this.offset = _this.begin + _this.tableLength + offset;
              data = [];
              for (i = _j = 1; 1 <= length ? _j <= length : _j >= length; i = 1 <= length ? ++_j : --_j) {
                _ref1 = _this.dataAccessors[dataType](_this.view, _this.offset), val = _ref1[0], _this.offset = _ref1[1];
                data.push(val);
              }
          ...
          match = value.match(this.dataTypePattern);
          ...
          if (length === 0 || length === 1) {
            (function(dataType) {
              ...
              accessor = function() {
                var val, _ref2;
                _ref2 = _this.dataAccessors[dataType](_this.view, _this.offset), val = _ref2[0], _this.offset = _ref2[1];
                return val;
              };
              return _this.accessors.push(accessor);
            })(dataType);
              ...
              if (dataType === 'X') {
                ...
                accessor = function() {
                  ...
                  for (i = _j = 1; 1 <= numBytes ? _j <= numBytes : _j >= numBytes; i = 1 <= numBytes ? ++_j : --_j) {
                    byte = _this.view.getUint8(_this.offset);
                    _this.offset += 1;
  ...
  CompressedImage = (function(_super) {
    ...
    function CompressedImage(header, view, offset) {
      this._accessor = __bind(this._accessor, this);
      ...
      this.zblank = this.constructor.setValue(header, "ZBLANK", void 0);
      this.blank = this.constructor.setValue(header, "BLANK", void 0);
      this.ztile = [];
      ...
      this.zmaskcmp = this.constructor.setValue(header, "ZMASKCMP", void 0);
      this.zquantiz = this.constructor.setValue(header, "ZQUANTIZ", "LINEAR_SCALING");
      this.bzero = this.constructor.setValue(header, "BZERO", 0);
      this.bscale = this.constructor.setValue(header, "BSCALE", 1);
    ...
    CompressedImage.prototype.defineColumnAccessors = function(header) {
      ...
      for (i = _i = 1, _ref = this.cols; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
        ...
        match = value.match(this.constructor.arrayDescriptorPattern);
        ...
        if (match != null) {
            ...
            case "COMPRESSED_DATA":
              (function(dataType) {
                return accessor = function() {
                  ...
                  pixels = new _this.constructor.typedArray[_this.algorithmParameters["BYTEPIX"]](_this.ztile[0]);
                  _this.constructor.Rice(data, _this.algorithmParameters["BLOCKSIZE"], _this.algorithmParameters["BYTEPIX"], pixels, _this.ztile[0]);
                  return pixels;
                };
              })(dataType);
              break;
          ...
          match = value.match(this.constructor.dataTypePattern);
          _ref1 = match.slice(1), length = _ref1[0], dataType = _ref1[1];
          ...
          if (length === 0 || length === 1) {
            (function(dataType) {
              return accessor = function() {
                var data, _ref2;
                _ref2 = _this.dataAccessors[dataType](_this.view, _this.offset), data = _ref2[0], _this.offset = _ref2[1];
                return data;
              };
            })(dataType);
          } else {
            (function(length, dataType) {
              return accessor = function() {
                var data, _j, _ref2, _ref3;
                data = new _this.constructor.typedArray[dataType](length);
                for (i = _j = 0, _ref2 = length - 1; 0 <= _ref2 ? _j <= _ref2 : _j >= _ref2; i = 0 <= _ref2 ? ++_j : --_j) {
                  _ref3 = _this.dataAccessors[dataType](_this.view, _this.offset), data[i] = _ref3[0], _this.offset = _ref3[1];
                }
                return data;
              };
            })(length, dataType);
    ...
    CompressedImage.prototype._accessor = function(dataType) {
      var data, i, length, offset, tempOffset, _i, _ref, _ref1;
      ...
      data = new this.constructor.typedArray[dataType](length);
      tempOffset = this.offset;
      this.offset = this.begin + this.tableLength + offset;
      for (i = _i = 0, _ref = length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        _ref1 = this.dataAccessors[dataType](this.view, this.offset), data[i] = _ref1[0], this.offset = _ref1[1];
      }
    ...
    CompressedImage.prototype._getRow = function() {
      ...
      this.offset = this.begin + this.totalRowsRead * this.rowByteSize;
      row = [];
      _ref = this.accessors;
  ...
  File = (function() {
    ...
    File.prototype.readHeader = function() {
      ...
      while (true) {
        ...
        i = 0;
        while (true) {
          start = this.BLOCKLENGTH - this.LINEWIDTH * (i + 1);
          end = this.BLOCKLENGTH - this.LINEWIDTH * i;
