...
(function() {
  var BinTable, CompImage, Data, Decompress, FITS, File, HDU, Header, Image, Module, Table;
  ...
  File = (function() {
    ...
    File.prototype.readData = function(header) {
      ...
      if (header.isPrimary() && header.hasDataUnit()) {
    ...
    File.prototype.getData = function(index) {
      ...
      return this.getHDU().data.getData();
    };
