  ...
  describe("FITS Header", function() {
    it('can parse a FITS header describing an image and ASCII table', function() {
      ...
      return runs(function() {
        ...
        return expect(hdr2['TUNIT4']).toBe('ARCSEC');
      });
    });
    it('can parse a FITS header describing an compressed image', function() {
      var fits, xhr;
      fits = null;
      xhr = new XMLHttpRequest();
      ...
      return runs(function() {
        ...
        return expect(hdr2['DATASUM']).toBe('3223591956');
      });
    });
    return it('can parse a FITS header describing a binary table', function() {
      var fits, xhr;
      fits = null;
      xhr = new XMLHttpRequest();
      ...
      return runs(function() {
        ...
        return expect(hdr2['MJDLIST']).toBe('51869');
      });
    });
  });
